...
## Applications
Vivin strongly believes that development of methods is only effective if the methods are applied for hands-on cases. The second general area of research is identifying areas of implementation for the diverse methods developed. 

### Quantum Chemistry

#### Excitation Energies and Photochemistry
